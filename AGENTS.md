...
This project is indexed by GitNexus as **dev-plane** (5453 symbols, 15047 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
