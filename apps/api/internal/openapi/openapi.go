		...
		Schemas: map[string]*Schema{
			...
			"PullRequest": {
				...
				Properties: map[string]*Schema{
					...
					"draft":               {Type: "boolean"},
					"created_by":          {Type: "string"},
					"reviewed_commit_id":  {Type: "string", Nullable: true, Description: "Immutable commit that was originally reviewed"},
					"published_commit_id": {Type: "string", Nullable: true, Description: "Exact commit published to the PR branch after replay/reverification"},
					"target_head_id":      {Type: "string", Nullable: true, Description: "Target branch head against which publication was verified"},
