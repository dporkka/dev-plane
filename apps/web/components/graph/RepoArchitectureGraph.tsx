  ...
  const nodes: Node<FileNodeData>[] = [
    ...
    },
    {
      ...
      data: {
        label: "docker.go",
        type: "file",
        path: "/packages/runtimes/docker.go",
      },
    },
    {
      id: "runtime-local",
      ...
      data: {
        label: "local.go",
        type: "file",
        path: "/packages/runtimes/local.go",
      },
    },
