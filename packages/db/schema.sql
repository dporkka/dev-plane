...
CREATE INDEX IF NOT EXISTS idx_reviewed_candidates_task_id ON reviewed_candidates(task_id);
CREATE INDEX IF NOT EXISTS idx_reviewed_candidates_workspace_id ON reviewed_candidates(workspace_id);
CREATE INDEX IF NOT EXISTS idx_reviewed_candidates_commit_id ON reviewed_candidates(candidate_commit_id);
